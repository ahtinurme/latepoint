...
use LatePoint\GoogleCalendarAddon\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \LatePoint\GoogleCalendarAddon\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \LatePoint\GoogleCalendarAddon\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
