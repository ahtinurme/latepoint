...
namespace LatePoint\GoogleCalendarAddon\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('LatePoint\GoogleCalendarAddon\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
