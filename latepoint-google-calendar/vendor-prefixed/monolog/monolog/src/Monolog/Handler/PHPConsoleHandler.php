...
namespace LatePoint\GoogleCalendarAddon\Monolog\Handler;

use LatePoint\GoogleCalendarAddon\Monolog\Formatter\LineFormatter;
use LatePoint\GoogleCalendarAddon\Monolog\Formatter\FormatterInterface;
use LatePoint\GoogleCalendarAddon\Monolog\Logger;
use LatePoint\GoogleCalendarAddon\Monolog\Utils;
 ...
 *
 *      $logger = new \LatePoint\GoogleCalendarAddon\Monolog\Logger('all', array(new \LatePoint\GoogleCalendarAddon\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['LatePoint\\GoogleCalendarAddon\\Monolog\\'], // array Hide calls of classes started with...
