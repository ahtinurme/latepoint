...
namespace LatePoint\GoogleCalendarAddon\Monolog;

use DateTimeZone;
use LatePoint\GoogleCalendarAddon\Monolog\Handler\HandlerInterface;
use LatePoint\GoogleCalendarAddon\Psr\Log\LoggerInterface;
use LatePoint\GoogleCalendarAddon\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \LatePoint\GoogleCalendarAddon\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
