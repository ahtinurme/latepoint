...
namespace LatePoint\GoogleCalendarAddon\Google\Service\Calendar\Resource;

use LatePoint\GoogleCalendarAddon\Google\Service\Calendar\CalendarList as CalendarListModel;
use LatePoint\GoogleCalendarAddon\Google\Service\Calendar\CalendarListEntry;
use LatePoint\GoogleCalendarAddon\Google\Service\Calendar\Channel;

/**
 * The "calendarList" collection of methods.
 * Typical usage is:
 *  <code>
 *   $calendarService = new \LatePoint\GoogleCalendarAddon\Google\Service\Calendar(...);
 *   $calendarList = $calendarService->calendarList;
 *  </code>
 */
class CalendarList extends \LatePoint\GoogleCalendarAddon\Google\Service\Resource
{
  /**
