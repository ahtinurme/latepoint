...
namespace LatePoint\GoogleCalendarAddon\Google\Service\Calendar;

class EventWorkingLocationPropertiesCustomLocation extends \LatePoint\GoogleCalendarAddon\Google\Model
{
  /**
   * @var string
   */
