...
namespace LatePoint\GoogleCalendarAddon\Google\Auth\Credentials;

use LatePoint\GoogleCalendarAddon\Google\Auth\CredentialsLoader;
use LatePoint\GoogleCalendarAddon\Google\Auth\GetQuotaProjectInterface;
use LatePoint\GoogleCalendarAddon\Google\Auth\HttpHandler\HttpClientCache;
use LatePoint\GoogleCalendarAddon\Google\Auth\HttpHandler\HttpHandlerFactory;
use LatePoint\GoogleCalendarAddon\Google\Auth\Iam;
use LatePoint\GoogleCalendarAddon\Google\Auth\IamSignerTrait;
use LatePoint\GoogleCalendarAddon\Google\Auth\ProjectIdProviderInterface;
use LatePoint\GoogleCalendarAddon\Google\Auth\SignBlobInterface;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\ClientException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\ConnectException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\RequestException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\ServerException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Psr7\Request;
 ...
 *
 *   use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\GCECredentials;
 *   use LatePoint\GoogleCalendarAddon\Google\Auth\Middleware\AuthTokenMiddleware;
 *   use LatePoint\GoogleCalendarAddon\GuzzleHttp\Client;
 *   use LatePoint\GoogleCalendarAddon\GuzzleHttp\HandlerStack;
 *
    ...
    GetQuotaProjectInterface
{
            ...
            try {
                ...
                $resp = $httpHandler(
                    new Request(
                        'GET',
                        $checkUri,
                        [self::FLAVOR_HEADER => 'LatePoint\GoogleCalendarAddon\Google']
                    ),
                    ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]
                );

                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'LatePoint\GoogleCalendarAddon\Google';
    ...
    private static function detectResidencyLinux(string $productNameFile): bool
    {
        if (file_exists($productNameFile)) {
            ...
            return 0 === strpos($productName, 'LatePoint\GoogleCalendarAddon\Google');
        }
        return false;
    }
