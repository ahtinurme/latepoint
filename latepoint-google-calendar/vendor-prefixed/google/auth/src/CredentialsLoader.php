...
use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\ExternalAccountCredentials;
use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
     ...
     * @return \LatePoint\GoogleCalendarAddon\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        $stack = \LatePoint\GoogleCalendarAddon\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \LatePoint\GoogleCalendarAddon\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
