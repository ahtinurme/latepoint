 ...
 *
 * ```
 * $sysvCache = new \LatePoint\GoogleCalendarAddon\Google\Auth\SysvCacheItemPool();
 * $creds = LatePoint\GoogleCalendarAddon\Google\Auth\ApplicationDefaultCredentials::getCredentials(
 *     $scope,
 *     null,
 *     null,
 *     $sysvCache
