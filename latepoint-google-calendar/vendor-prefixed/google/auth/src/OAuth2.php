...
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Psr7\Query;
...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \LatePoint\GoogleCalendarAddon\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \LatePoint\GoogleCalendarAddon\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \LatePoint\GoogleCalendarAddon\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
