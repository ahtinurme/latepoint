...
namespace LatePoint\GoogleCalendarAddon\Google\Service;

use LatePoint\GoogleCalendarAddon\Google\Exception as GoogleException;
use LatePoint\GoogleCalendarAddon\Google\Http\MediaFileUpload;
use LatePoint\GoogleCalendarAddon\Google\Model;
use LatePoint\GoogleCalendarAddon\Google\Utils\UriTemplate;
...
class Resource
{
    ...
    /** @var \LatePoint\GoogleCalendarAddon\Google\Client $client */
    private $client;
