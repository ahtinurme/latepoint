...
namespace LatePoint\GoogleCalendarAddon\Google;

use BadMethodCallException;
use DomainException;
use LatePoint\GoogleCalendarAddon\Google\AccessToken\Revoke;
use LatePoint\GoogleCalendarAddon\Google\AccessToken\Verify;
use LatePoint\GoogleCalendarAddon\Google\Auth\ApplicationDefaultCredentials;
use LatePoint\GoogleCalendarAddon\Google\Auth\Cache\MemoryCacheItemPool;
use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\ServiceAccountCredentials;
use LatePoint\GoogleCalendarAddon\Google\Auth\Credentials\UserRefreshCredentials;
use LatePoint\GoogleCalendarAddon\Google\Auth\CredentialsLoader;
use LatePoint\GoogleCalendarAddon\Google\Auth\FetchAuthTokenCache;
use LatePoint\GoogleCalendarAddon\Google\Auth\GetUniverseDomainInterface;
use LatePoint\GoogleCalendarAddon\Google\Auth\HttpHandler\HttpHandlerFactory;
use LatePoint\GoogleCalendarAddon\Google\Auth\OAuth2;
use LatePoint\GoogleCalendarAddon\Google\AuthHandler\AuthHandlerFactory;
use LatePoint\GoogleCalendarAddon\Google\Http\REST;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Client as GuzzleClient;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\ClientInterface;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use LatePoint\GoogleCalendarAddon\Monolog\Handler\StreamHandler as MonologStreamHandler;
use LatePoint\GoogleCalendarAddon\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use LatePoint\GoogleCalendarAddon\Monolog\Logger;
use LatePoint\GoogleCalendarAddon\Psr\Cache\CacheItemPoolInterface;
...
use LatePoint\GoogleCalendarAddon\Psr\Log\LoggerInterface;
...
class Client
{
     ...
     * @throws \LatePoint\GoogleCalendarAddon\Google\Exception
    ...
    {
        $guzzleVersion = null;
        if (defined('\LatePoint\GoogleCalendarAddon\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('\LatePoint\GoogleCalendarAddon\GuzzleHttp\ClientInterface::VERSION')) {
