...
{
    /**
     * If you need to specify a NULL JSON value, use LatePoint\GoogleCalendarAddon\Google\Model::NULL_VALUE
     ...
     * @throws \LatePoint\GoogleCalendarAddon\Google\Exception Thrown if $obj isn't an array.
