...
namespace LatePoint\GoogleCalendarAddon\Google\Task;

use LatePoint\GoogleCalendarAddon\Google\Service\Exception as GoogleServiceException;
use LatePoint\GoogleCalendarAddon\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \LatePoint\GoogleCalendarAddon\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \LatePoint\GoogleCalendarAddon\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
