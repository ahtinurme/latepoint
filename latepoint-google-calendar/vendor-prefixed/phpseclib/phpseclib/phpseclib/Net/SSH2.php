 ...
 *
 *    $ssh = new \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2('www.domain.tld');
...
namespace LatePoint\GoogleCalendarAddon\phpseclib3\Net;

use LatePoint\GoogleCalendarAddon\phpseclib3\Common\Functions\Strings;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Blowfish;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\ChaCha20;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\AsymmetricKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\PrivateKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\PublicKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\SymmetricKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\DH;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\DSA;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Hash;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Random;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\RC4;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Rijndael;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\RSA;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Twofish;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\ConnectionClosedException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\InsufficientSetupException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\InvalidPacketLengthException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\NoSupportedAlgorithmsException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\TimeoutException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\UnableToConnectException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\UnsupportedAlgorithmException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\UnsupportedCurveException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger;
use LatePoint\GoogleCalendarAddon\phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
