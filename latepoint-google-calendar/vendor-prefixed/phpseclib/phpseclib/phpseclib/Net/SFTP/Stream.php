...
namespace LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP;

use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\PrivateKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP;
...
class Stream
{
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     */
