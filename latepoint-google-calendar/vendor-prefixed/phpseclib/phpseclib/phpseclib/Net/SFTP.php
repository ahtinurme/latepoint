 ...
 *
 *    $sftp = new \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP('www.domain.tld');
...
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP::put()
     */
     ...
     *
     * By default, \LatePoint\GoogleCalendarAddon\phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
