 ...
 * <code>
 * <?php
 *    $a = new \LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger(2);
 *    $b = new \LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace LatePoint\GoogleCalendarAddon\phpseclib3\Math;

use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\BadConfigurationException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'LatePoint\\GoogleCalendarAddon\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger('10');
     *    $b = new \LatePoint\GoogleCalendarAddon\phpseclib3\Math\BigInteger('20');
     *
