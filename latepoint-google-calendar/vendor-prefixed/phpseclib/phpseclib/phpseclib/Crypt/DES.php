 ...
 *
 *    $des = new \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends BlockCipher
{
     ...
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\DES::setupKey()
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
