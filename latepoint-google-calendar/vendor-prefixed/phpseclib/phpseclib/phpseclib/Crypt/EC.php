 ...
 *
 * $private = \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC::createKey('secp256k1');
...
namespace LatePoint\GoogleCalendarAddon\phpseclib3\Crypt;

use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\AsymmetricKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\Curve25519;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\Curve448;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\Ed25519;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\Ed448;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Parameters;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\PrivateKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\PublicKey;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\BadConfigurationException;
...
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\UnsupportedOperationException;
use LatePoint\GoogleCalendarAddon\phpseclib3\File\ASN1;
use LatePoint\GoogleCalendarAddon\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\\' . $curveName;
