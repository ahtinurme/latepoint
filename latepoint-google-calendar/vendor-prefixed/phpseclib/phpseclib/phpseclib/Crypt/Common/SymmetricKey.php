...
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\BadDecryptionException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\BadModeException;
use LatePoint\GoogleCalendarAddon\phpseclib3\Exception\InconsistentSetupException;
...
use LatePoint\GoogleCalendarAddon\phpseclib3\Math\BinaryField;
use LatePoint\GoogleCalendarAddon\phpseclib3\Math\PrimeField;
...
abstract class SymmetricKey
{
     ...
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     */
    const MODE_CTR = -1;
    /**
     ...
     * Mode Map
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\SymmetricKey::__construct()
     */
    const MODE_MAP = [
        'ctr'    => self::MODE_CTR,
        'ecb'    => self::MODE_ECB,
     ...
     * Engine Reverse Map
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\SymmetricKey::getEngine()
     */
    const ENGINE_MAP = [
     ...
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Twofish::setKey()
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Twofish::setIV()
     * @var bool
     */
                    ...
                    if (strlen($_buffer["ciphertext"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            if (strlen($_block) > strlen($_buffer["ciphertext"])) {
                                $in = $_xor;
                                ' . $encrypt_block . '
                                \LatePoint\GoogleCalendarAddon\phpseclib3\Common\Functions\Strings::increment_str($_xor);
                                $_buffer["ciphertext"].= $in;
                            }
                            $_key = \LatePoint\GoogleCalendarAddon\phpseclib3\Common\Functions\Strings::shift($_buffer["ciphertext"], ' . $block_size . ');
                ...
                $encrypt = $init_encrypt . '
                    ...
                    if (strlen($_buffer["xor"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            $_key = \LatePoint\GoogleCalendarAddon\phpseclib3\Common\Functions\Strings::shift($_buffer["xor"], ' . $block_size . ');
                            $_ciphertext.= $_block ^ $_key;
                        }
                    } else {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
