...
namespace LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Formats\Keys;

use LatePoint\GoogleCalendarAddon\phpseclib3\Common\Functions\Strings;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\secp256k1;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\secp256r1;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\secp384r1;
use LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     * @param \LatePoint\GoogleCalendarAddon\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
