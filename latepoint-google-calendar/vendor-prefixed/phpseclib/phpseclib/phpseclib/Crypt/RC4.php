 ...
 *
 *    $rc4 = new \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\RC4();
 *
 *    $rc4->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
{
    /**
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\RC4::_crypt()
     */
    const ENCRYPT = 0;
     ...
     * Key Length (in bytes)
     *
     * @see \LatePoint\GoogleCalendarAddon\phpseclib3\Crypt\RC4::setKeyLength()
     * @var int
     */
