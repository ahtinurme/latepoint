...
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\BadResponseException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\TooManyRedirectsException;
