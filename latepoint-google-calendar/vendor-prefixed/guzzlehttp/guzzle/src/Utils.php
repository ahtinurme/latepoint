...
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Exception\InvalidArgumentException;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Handler\CurlHandler;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Handler\CurlMultiHandler;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Handler\Proxy;
use LatePoint\GoogleCalendarAddon\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
     ...
     *
     * @return callable(\LatePoint\GoogleCalendarAddon\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
